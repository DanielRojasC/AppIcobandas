                    ...
                    if (contra.toString().equals("")) {
                            ...
                            final StringRequest requestLogin = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    ...
                                    if (response.equals("\uFEFF[]")) {
                                        ...
                                        db.execSQL("insert into usuario values('" + Login.loginJsons.get(0).getNombreUsuario() + "','" + loginJsons.get(0).getNombreVendedor() + "','" + loginJsons.get(0).getContraseñaUsuario() + "')");
                                        ...
                                        for (int i = 0; i < loginJsons.size(); i++) {
                                            ...
                                            db.execSQL("INSERT INTO plantas values(" + loginJsons.get(i).getCodplanta() + ",'" + loginJsons.get(i).getNombreUsuario() + "','" + loginJsons.get(i).getNit() + "','" + loginJsons.get(i).getNameplanta() + "',null,null)");

                                            if (loginJsons.get(i).getIdRegistro() != null) {
                                                db.execSQL("INSERT INTO registro values(" + loginJsons.get(i).getIdRegistro() + ",'" + loginJsons.get(i).getFechaRegistro() + "'," + loginJsons.get(i).getIdTransportador() + "," + loginJsons.get(i).getCodplanta() + ",'" + loginJsons.get(i).getNombreUsuario() + "')");
                                            }
                                        }
                        ...
                        else
                        {
                            ...
                            try
                            {
                                ...
                                {
                                    Log.e("NOMBRE USUARIO: ",cursor.getString(0));
                                    Log.e("NOMBRE VENDEDOR: ",cursor.getString(1));
                                    Log.e("CONTRASEÑA USUARIO: ",cursor.getString(2));
