...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toggle.setHomeAsUpIndicator(R.drawable.icono);*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.ingresarDatos) {
            getSupportFragmentManager().beginTransaction().replace(R.id.contenedor, new FragmentSeleccionarTransportador()).commit();

        } else if (id == R.id.registrarCliente) {
            getSupportFragmentManager().beginTransaction().replace(R.id.contenedor, new FragmentAgregarCliente()).commit();
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.contenedor, new FragmentAgregarPlantas()).commit();
