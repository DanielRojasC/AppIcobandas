select registro.idRegistro,registro.usuarioRegistro, registro.estadoRegistro,registro.fechaRegistro,plantas.nameplanta, transportador.tipoTransportador,anchoBandaTransportadora,bandaTransportadora.cauchoVPlow,espesorVPlow,count(transportador.idTransportador) as 'Cantidad de Equipos'
...
transportador.tipoTransportador,anchoBandaTransportadora,bandaTransportadora.cauchoVPlow,espesorVPlow